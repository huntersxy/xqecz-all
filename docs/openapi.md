...
| 方法 | 路径 | 认证 | 功能 | 请求 | 响应 data |
|------|------|------|------|------|-----------|
| POST | /notifications/device | 是 | 注册设备 | JSON | — |
| DELETE | /notifications/device/{token} | 是 | 注销设备 | query | — |
| GET | /notifications/list | 是 | 通知列表 | query | array<Notification> |
| GET | /notifications/unread-count | 是 | 未读计数 | — | — |
| PUT | /notifications/{id}/read | 是 | 标记已读 | query | — |
| PUT | /notifications/read-all | 是 | 全部已读 | — | — |
